...
// Return the number of ways that all n2 elements of a2 appear in
    ...
    // n2 is 0) appears in a sequence of length n1 in 1 way, even if n1
    // is 0.  For example, if a1 is the 7 element array
...
int countIncludes(const double a1[], int n1, const double a2[], int n2)
{
    ...
    if (a1[0] == a2[0]) return countIncludes(a1 + 1, n1 - 1, a2 + 1, n2 - 1) +
...
int main() {
    ...
    assert(countIncludes(arr1, 7, arr2, 3) == 0);
    assert(countIncludes(arr1, 7, arr3, 3) == 3);
    assert(countIncludes(arr1, 7, arr4, 3) == 3);
    order(arr1, 7);
